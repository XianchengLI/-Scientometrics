...
class MAGJournalSpider(Spider):
    name = 'magjournalspider'
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(MAGJournalSpider, cls).from_crawler(crawler, *args, **kwargs)
    ...
    def start_requests(self):
        response = GetTitle.get_journal(self.url_limit, self.spider_id, self.get_cnt)
        self.get_cnt += 1
    ...
    def parse(self, response):
        ...
        try:
            ...
            item['journal_id'] = response.meta['id']
            ...
            if 'topFieldsOfStudy' in result:
                item['fields'] = result['topFieldsOfStudy']
            else:
                item['fields'] = ''

            if 'jn' in result['entity']:
                item['name'] = result['entity']['jn']
            else:
                item['name'] = ''
